...
$(document).ready(function () {
  ...
  $(".collapse.show").each(function () {
    $(this).prev(".legal-card-head").find(".fa").addClass("fa-angle-up").removeClass("fa-angle-down");
  });

  // Toggle right and down arrow icon on show hide of collapse element
  $(".collapse").on('show.bs.collapse', function () {
    $(this).prev(".legal-card-head").find(".fa").removeClass("fa-angle-down").addClass("fa-angle-up");
  }).on('hide.bs.collapse', function () {
    $(this).prev(".legal-card-head").find(".fa").removeClass("fa-angle-up").addClass("fa-angle-down");
  });
});
// Legal Notice End